...
// for interface to managed code need to have the .h file for use of the calling side

// Python does not consume a .h-- have to "just know"
//	TCHAR maps to string on input
//	
